...
@section('content')
    ...
    <form action="{{ route('admin.ad.update', ['id' => $ad->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group" style="margin-bottom: 10px">
            ...
            @foreach ($languages as $language)
                <div style="display:flex; align-items: center">
                    ...
                    <div style="flex: 1;">
                        <input value='{{ old('name.' . $language->id, $ad['details'][$language->id]->name) }}' name='name[{{ $language->id }}]' type="text"
        ...
        <div class="form-group" style="margin-bottom: 10px">
            ...
            @foreach ($languages as $language)
                <div style="display:flex; align-items: center">
                    ...
                    <div style="flex: 1;">
                        <input value='{{ old('meta_title.' . $language->id, $ad['details'][$language->id]->meta_title) }}' name='meta_title[{{ $language->id }}]' type="text"
        ...
        <div class="form-group" style="margin-bottom: 10px">
            ...
            @foreach ($languages as $language)
                <div style="display:flex; align-items: center">
                    ...
                    <div style="flex: 1;">
                        <input value='{{ old('meta_description.' . $language->id, $ad['details'][$language->id]->meta_description) }}' name='meta_description[{{ $language->id }}]'
        ...
        <div class="form-group" style="margin-bottom: 10px">
            ...
            @foreach ($languages as $language)
                <div style="display:flex; align-items: center">
                    ...
                    <div style="flex: 1;">
                        <input value='{{ old('meta_keywords.' . $language->id, $ad['details'][$language->id]->meta_keywords) }}' name='meta_keywords[{{ $language->id }}]' type="text"
        ...
        <div class="form-group" style="margin-bottom: 10px">
            ...
            @foreach ($languages as $language)
                <div style="display:flex; align-items: center">
                    ...
                    <div style="flex: 1;">
                        <input value='{{ old('slug.' . $language->id, $ad['details'][$language->id]->slug) }}' name='slug[{{ $language->id }}]' type="text"
        ...
        <div class="form-group" style="margin-bottom: 10px">
            ...
            <input value='{{ old('sort_order', $ad->sort_order) }}' name='sort_order' type="text" class="form-control" id='sort_order'
        ...
        <div class="form-group" style="margin-bottom: 10px">
            ...
            <select name="parent_ids[]" class="select2" style="width: 100%" multiple>
                <option value="">Kategori Seç</option>
                @foreach ($categories as $item)
                    <option value="{{ $item->id }}" {{ in_array($item->id, $selectedCategories) ? 'selected' : '' }}> {{ $item->details->name }}</option>
                @endforeach
            </select>
                ...
                <div style="display:flex; align-items: center">
                    ...
                    <div style="flex: 1;">
                        <textarea name='description[{{ $language->id }}]'
                            id='content{{ $language->id }}'>{{ old('description.' . $language->id, $ad['details'][$language->id]->description) }}
                        </textarea>
                    </div>
                </div>
